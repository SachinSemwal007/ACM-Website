...
const Home = () => {
  ...
  return (
    <div className={`relative min-h-screen transition-all duration-700 overflow-hidden ${isDark ? 'bg-black' : 'bg-gradient-to-br from-slate-900 via-blue-900/20 to-indigo-900/30'}`}>
      ...
      <div className='w-full'>-
        <h1 className='text-center text-5xl font-bold dark:text-white text-blac'>PROJECTS</h1>
      </div>
