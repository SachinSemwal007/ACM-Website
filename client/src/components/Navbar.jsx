        ...
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="hidden md:flex space-x-6 w-full pl-7 lg:pl-16">
              <a
                ...
                className="text-black hover:text-blue-900 lg:text-[16px] text-[14px] cursor-pointer"
              >
                PRODUCT
              </a>
    ...
    {/* {hamburger icon} */}
      ...
      <div className="md:hidden px-4 pb-4 bg-white border-t border-gray-200">
        <div className="flex flex-col space-y-3 pt-3">
          <a
            onClick={() => navigate('/product')}
            className="text-gray-700 hover:text-blue-900 text-[16px] py-2 border-1 rounded-md px-3 cursor-pointer"
          >
            PRODUCT
          </a>
          <a
            onClick={() => navigate('/support')}
            className="text-gray-700 hover:text-blue-600 text-[16px] py-2 border-1 rounded-md px-3 cursor-pointer"
          >
            SUPPORT
          </a>
          <a
