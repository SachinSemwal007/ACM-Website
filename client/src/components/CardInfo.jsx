  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-1/2 space-y-4 text-center md:text-left px-6">
        <h5 className="text-blue-500 uppercase tracking-wide text-sm font-semibold">
          {smallTopic}
        </h5>
        ...
        <button className="mt-4 px-6 py-2 border border-blue-500 text-blue-500 bg-white rounded-md hover:bg-blue-500 hover:text-white transition duration-300">
          {buttonText}
        </button>
      </div>
    </div>
